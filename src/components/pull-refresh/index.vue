<template>
  <div class="lcb-pull-refresh">
    <div class="lcb-pull-refresh__track"
      :style="style"
    ...
    >
      <div class="lcb-pull-refresh__head">
        <slot v-if="status === 'normal'" name="normal" />
        <slot v-if="status === 'pulling'" name="pulling">
          <span class="lcb-pull-refresh__text">{{ pullingText || '下拉即可刷新...' }}</span>
        </slot>
        <slot v-if="status === 'loosing'" name="loosing">
          <span class="lcb-pull-refresh__text">{{ loosingText || '释放即可刷新...' }}</span>
        </slot>
        <slot v-if="status === 'loading'" name="loading">
          <div class="lcb-pull-refresh__loading">
            <loading />
