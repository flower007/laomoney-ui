<template>
  <div
    :class="['lcb-picker-column', className]"
    :style="columnStyle"
  ...
  >
    <ul :style="wrapperStyle">
      <li
        ...
        class="ellipsis"
        :class="['lcb-picker-column__item', {
          'lcb-picker-column__item--disabled': isDisabled(option),
          'lcb-picker-column__item--selected': index === currentIndex
        }]"
